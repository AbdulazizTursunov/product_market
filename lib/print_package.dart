...
class MyPrintApp extends StatefulWidget {
  const MyPrintApp({Key? key}) : super(key: key);

  @override
  State<MyPrintApp> createState() => _MyPrintAppState();
}

class _MyPrintAppState extends State<MyPrintApp> {
  final _directprintPlugin = Directprint();
  String _printStatus = 'Flutter';
  String _printerName = 'direct print ';
  String _jobName = '2021';
